...
!(async () => {
  ...
  console.log(`------------- 共${dkdtokenkeyArr.length}个账号----------------\n`)
  for (let i = 0; i < dkdtokenkeyArr.length; i++) {
  dkdtokenbodyVal = dkdtokenbodyArr[i];
  dkdtokenkeyVal = dkdtokenkeyArr[i];
  //dkdcashurlVal = dkdcashurlArr[i];
  dkdcashkeyVal = dkdcashkeyArr[i];
  //dkdlottourlVal = dkdlottourlArr[i];
  dkdlottokeyVal = dkdlottokeyArr[i];
