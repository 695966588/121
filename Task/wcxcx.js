...
let wcxcx = [
  {
    "id": 24798,
    "weixin": "",
    "url": "https://yd.wcyd168.com/hfTask/getUserByToken",
    "headers": {
      "Accept-Encoding": "gzip,compress,br,deflate",
      "Connection": "keep-alive",
      "Referer": "https://servicewechat.com/wxcf01e00294c3f91f/9/page-frame.html",
      "Content-Type": "application/x-www-form-urlencoded;charset=utf-8;",
      "Host": "yd.wcyd168.com",
      "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 14_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/7.0.21(0x17001525) NetType/WIFI Language/zh_CN"
    },
    "body": "token=F7q5645II%2B2JirL1%5C%2FZCQgw%3D%3D"
  },
  {
    "id": 24804,
    "weixin": "猪头3",
    ...
    "body": "token=mxDBYQu7ppW36oyxK%2BIwZA%3D%3D"
  },
  {
    "id": 24805,
    "weixin": "猪头溜溜球",
    ...
    "body": "token=dgVwNNFsLepMAMLXW8jiBw%3D%3D"
  }
]
let needNotice = $.getval('wcxcxNotice') == 'true'
let concurrency = ($.getval('wcxcxConcurrency') || '5') - 0 // 并发执行任务的账号数，默单账号循环执行
